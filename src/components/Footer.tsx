    ...
    <footer className="border-t border-white/10 bg-black relative z-10 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center gap-3 group inline-flex mb-6">
              ...
              <span className="text-xl font-heading font-extrabold tracking-tight text-white drop-shadow-sm">Slim<span className="text-accent-green">Koop</span></span>
            </Link>
        ...
        <div className="border-t border-white/10 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">© {new Date().getFullYear()} SlimKoop. Alle rechten voorbehouden.</p>
