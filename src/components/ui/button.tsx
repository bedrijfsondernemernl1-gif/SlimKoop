...
const buttonVariants = cva(
  "cursor-pointer inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-accent-green text-black font-semibold shadow hover:shadow-[0_0_20px_rgba(0,200,83,0.4)]",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-white/20 glass hover:bg-white/10 text-white",
        secondary:
        ...
        glass: "glass text-white hover:bg-white/10 hover:border-white/30 transition-all",
      },
      size: {
