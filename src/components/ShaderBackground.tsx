  ...
  useEffect(() => {
    ...
    const fragmentShaderSource = `
      ...
      void main() {
          ...
          vec3 primaryBlue = vec3(0.02, 0.08, 0.15);
          ...
          baseCol += vec3(0.0, 0.78, 0.32) * smoothstep(0.985, 1.02, edge) * 0.4;
          baseCol += vec3(0.0, 0.4, 0.3) * smoothstep(0.94, 1.0, edge) * 0.15;
    ...
    const isMobileUniformLocation = gl.getUniformLocation(program, 'isMobile');
