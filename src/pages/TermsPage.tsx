        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 font-light max-w-2xl mx-auto">
              Lees deze voorwaarden zorgvuldig door voordat je gebruikmaakt van SlimKoop.
            </p>
          </div>
            ...
            <div className="relative z-10 space-y-8 text-gray-300 leading-relaxed text-sm md:text-base">
              <section>
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                  ...
                  1. Diensten van SlimKoop
                </h2>
                <p>
                  SlimKoop biedt een platform voor de analyse van tweedehands voertuigen op basis van online advertenties en openbare data. De resultaten zijn bedoeld als hulpmiddel en advies, niet als bindende taxatie of garantie op de staat van een voertuig.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc ml-6 mt-3 space-y-2">
                  ...
                  <li>Je gebruikt het platform niet voor illegale doeleinden of om de systemen van SlimKoop te overbelasten.</li>
                  <li>Het is niet toegestaan om geautomatiseerde scripts te gebruiken om data van SlimKoop te scrapen zonder uitdrukkelijke toestemming.</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  Hoewel onze AI-modellen met de grootste zorg zijn samengesteld, kan SlimKoop niet aansprakelijk worden gesteld voor:
                </p>
                <ul className="list-disc ml-6 mt-3 space-y-2">
              ...
              <section>
                ...
                <p>
                  Alle inhoud op deze website, inclusief de AI-algoritmen en de gegenereerde rapporten, is eigendom van SlimKoop en mag niet zonder toestemming worden gekopieerd of gedistribueerd.
                </p>
              </section>
