      ...
      <div className="container mx-auto px-6 relative z-10 flex-1 pb-24">
        ...
        >
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-white mb-6">Over SlimKoop</h1>
